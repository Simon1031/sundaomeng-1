...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath{
    ...
    if ([_dataArray count] > 0) {
        ...
        if (cell == nil) {
            ...
            //        sexImageView.backgroundColor = [UIColor greenColor];
...
- (void)tableView:(UITableView *)tableView didSelectRowAtIndexPath:(NSIndexPath *)indexPath{
    ...
    //    if (_userHomeViewController == nil) {
    //        _userHomeViewController = [[UserHomeViewController alloc] init];
    //        _userHomeViewController.userId = myModel.user_id;
    //        _userHomeViewController.userName = myModel.name;
    //        [self.navigationController pushViewController:_userHomeViewController animated:YES];
    //    }
