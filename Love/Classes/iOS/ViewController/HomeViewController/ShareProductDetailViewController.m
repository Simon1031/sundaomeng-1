...
//        salesLabel.textColor = [UIColor colorWithWhite:0 alpha:0.6];
...
//        saleLable.adjustsFontSizeToFitWidth = YES;
...
- (void)shareButtonAction:(UIButton *)sender{
    NSLog(@"分享");
    LOVShareActivityView *shareView = [[LOVShareActivityView alloc] initWithShareType:LOVShareTypeSinaWeibo shareTitle:_productName shareDesc:_productIntro shareURL:nil shareImageURL:nil];
    [shareView show];
}
