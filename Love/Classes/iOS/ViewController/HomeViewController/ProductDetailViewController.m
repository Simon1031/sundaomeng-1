...
- (UIView *)tableView:(UITableView *)tableView viewForHeaderInSection:(NSInteger)section{
    if (section == 0) {
        ...
        _likeButton.layer.borderWidth = 1.f;
        ...
        _commityButton.layer.borderWidth = 1.f;
...
//        [view addSubview:lineView];
    ...
    if (section == 4) {
        ...
        UIImageView *imageView = [[UIImageView alloc] initWithFrame:CGRectMake(10, 5, 22, 20)];
        imageView.backgroundColor = [UIColor clearColor];
        imageView.image = [UIImage imageNamed:@"icon_discuss"];
        [view addSubview:imageView];
        
        UILabel *myLabel = [[UILabel alloc] initWithFrame:CGRectMake(imageView.frame.origin.x + 30, 0, 165, 30)];
...
- (void)shareButtonAction:(UIButton *)sender{
    NSLog(@"分享");
    LOVShareActivityView *shareView = [[LOVShareActivityView alloc] initWithShareType:LOVShareTypeSinaWeibo shareTitle:_userName shareDesc:_shareContent shareURL:nil shareImageURL:nil];
    [shareView show];
}
