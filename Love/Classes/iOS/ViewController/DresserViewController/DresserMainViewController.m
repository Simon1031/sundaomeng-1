...
- (void)shareButtonAction:(UIButton *)sender{
    NSLog(@"分享");
    LOVShareActivityView *shareView = [[LOVShareActivityView alloc] initWithShareType:LOVShareTypeSinaWeibo shareTitle:_liveName shareDesc:_intro shareURL:nil shareImageURL:nil];
    [shareView show];
}
