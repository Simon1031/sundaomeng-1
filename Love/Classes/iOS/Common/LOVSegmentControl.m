...
//    segmentLabel.font = [UIFont fontWithName:@"Courier" size:20];
...
- (void)layoutSubviews
{
    ...
    [_segments enumerateObjectsUsingBlock:^(UILabel *item, NSUInteger idx, BOOL *stop) {
        ...
        //CGRect rect = [text boundingRectWithSize:CGSizeMake(200, self.frame.size.height) options:NSStringDrawingUsesLineFragmentOrigin attributes:@{NSFontAttributeName: [UIFont systemFontOfSize:14.f]} context:nil];
        item.alpha = 1;
