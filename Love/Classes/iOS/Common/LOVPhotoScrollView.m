...
//            imgHeight = (imageViewWidth/imgWidth) * imgHeight;
            
            [imageView setFrame:CGRectMake((backgroundSize.width - imageViewWidth)/2, (backgroundSize.height - imageViewHeight)/2, imageViewWidth, imageViewHeight)];
            NSLog(@"%@",imageView);
